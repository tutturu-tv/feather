...
```
### Figma
Feather is available as a [Figma component library](https://www.figma.com/file/LxmeRMH7n8KUHAcCsdtJff/Feather-Component-Library-Unofficial?node-id=0%3A1). To use the components, log in to your Figma account and **duplicate** the file to your drafts.
